...
PRAC_DIR = os.path.dirname(BASE_DIR)
...
SECRET_KEY = '%sgdn^95=@g1&b=0savcu^(-^j#a6qp1kicl2fasijg%^vz$a6'
...
STATICFILES_DIRS = [os.path.join(BASE_DIR, "practice/static"), ]


MEDIA_ROOT = os.path.join(BASE_DIR, "media")
STATIC_ROOT = os.path.join(PRAC_DIR, "static")
